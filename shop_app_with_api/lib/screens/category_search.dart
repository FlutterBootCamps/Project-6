            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: "Search for Category by ID",
                  hintStyle: TextStyle(
                    color: grey,
                    fontSize: 18,
              ...
              onTap: () async {
                ...
                if (idController.text.isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Please enter a Category ID')));
                } else {
                  context
                      .read<RegistrationBloc>()
                      .add(GetOneCategoriesEvent(id: int.parse(idController.text)));
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if (state.users["id"] != null) {
                              return CategoryCard(category: state.users);
                            }
                            return null;
                          });
                    }
                    return const Text("Sory can't found  Category", style: TextStyle(color: grey),);
                  },
                ),
              ),
            ),
